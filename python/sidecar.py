...
def build_local_llm_rewrite_prompt(
    ...
    return (
        ...
        "6. Improve sentence breaks conservatively so the result reads naturally.\n"
        "7. Use punctuation that matches the target language.\n"
        "8. For Traditional Chinese, prefer full-width punctuation such as ， 。 ： ； ？ ！\n"
        "9. Return only the rewritten text.\n"
        "Protected terms:\n"
        f"{protected_block}\n"
        "Literal transcript:\n"
